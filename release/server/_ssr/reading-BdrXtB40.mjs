...
import { C as tapPulse, _ as playRustle, a as IconCutBack, h as cn, p as IconThreadKnot, v as playThud, w as useOracleStore } from "./sound-BzWTQRwe.mjs";
import { a as searchFromIds, i as saveLastReading, n as idsFromSearch, t as AppShell } from "./app-shell--mhZwqja.mjs";
import { t as Button } from "./button-CYW9CMG1.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { a as weaveReading, c as spreadById, i as SPREADS, o as Route$5, s as CardBack } from "./router-B7krle5x.mjs";
import { t as LivingMedia } from "./living-media-DG7j7BdH.mjs";
import { t as addJournalEntry } from "./journal-DP38_61i.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/reading-BdrXtB40.js
...
function Silhouette({ spread }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		"aria-hidden": "true",
		children: spread.roles.map((role) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-2.5 w-[7px] bg-current opacity-70" }, role))
	});
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						className: "mt-4 divide-y divide-[#2a211e]",
						children: SPREADS.map((spread) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								"aria-pressed": on,
								className: cn("stitch-run flex w-full items-center gap-4 py-3 text-left", on ? "text-sand" : "text-muted-foreground"),
								"data-active": on,
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Silhouette, { spread }),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "shrink-0 font-[family-name:var(--font-ui)] text-[11px] tracking-[0.16em] uppercase",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-4 text-[11px] tracking-[0.16em] text-muted-foreground uppercase",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(IconThreadKnot, {}), "Сплести нити"]
			})
		]
	});
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			busy ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(IconThreadKnot, { className: "text-primary" }), "Нить тянется…"]
			}) : null,
