...
import { h as cn, n as DECK_ABOUT, r as DECK_WELCOME, t as AUTHOR_IMAGE, w as useOracleStore } from "./sound-BzWTQRwe.mjs";
import { t as AppShell } from "./app-shell--mhZwqja.mjs";
import { t as Button } from "./button-CYW9CMG1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/about-a5r4TZgW.js
var import_jsx_runtime = require_jsx_runtime();
function AboutPage() {
	const settings = useOracleStore((s) => s.settings);
	const filled = useOracleStore((s) => s.cards).filter(isCardFilled).length;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppShell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			...
			aboutBlocks.map((para, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [i > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "gold-split" }) : null, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: cn("mt-0 text-base leading-[1.65]", i === 0 && "drop-cap"),
				children: para
			})] }, para.slice(0, 24))),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					"Сто восемь карт. Вплетено ",
					filled,
					" из 108. Ткач читает ядро карт и плетёт один сюжет под вопрос — одна нить, узел, чужая нитка, две нити или кросна."
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "mt-3 font-display text-4xl tracking-[0.1em] text-sand",
						children: "Темнояр"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "gold-rule mt-4 w-16" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "gramota mt-8 overflow-hidden",
