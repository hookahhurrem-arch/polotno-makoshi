...
import { S as stopCrackle, a as IconCutBack, b as soundEnabled, c as IconHearth, f as IconSpindle, h as cn, i as IconBookClasp, m as IconWindow, p as IconThreadKnot, w as useOracleStore, x as startCrackle, y as setSoundEnabled } from "./sound-BzWTQRwe.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/app-shell--mhZwqja.js
...
function Atmosphere() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"aria-hidden": "true",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hearth" }),
...
function AppShell({ children, className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: cn("relative z-10 mx-auto max-w-6xl px-7 pb-32 pt-10 md:px-12 md:pb-16 md:pt-14", className),
